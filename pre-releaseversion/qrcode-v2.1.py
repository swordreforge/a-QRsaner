...
from PIL import Image, ImageTk, ImageOps, ImageEnhance, ImageChops, ExifTags #如用ImageOps
import requests
...
import struct
import datetime
from PIL.PngImagePlugin import PngInfo #自实现类，如用
import zlib
import concurrent.futures #并发模块，如引
import json
...
class QRScannerApp(TkinterDnD.Tk):
    def __init__(self):
        ...
        self.settings_module = SettingsModule(self, self.config)  # 新增设置模块
        ...
        self.settings_module.init_ui(settings_tab)  # 初始化设置UI
